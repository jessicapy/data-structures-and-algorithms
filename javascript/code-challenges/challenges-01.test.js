...
const addExclamation = (arr) => {
  // Solution code here...
  // Create a local array to store the modified strings
  let result = [];

  // Use forEach to loop over the input array
  arr.forEach((str) => {
    // Add "!" to the end of each string and push it to the result array
    result.push(str + "!");
  });
...
const allUpperCase = (arr) => {
  ...
  // Use forEach to loop over the input array
  arr.forEach((str) => {
    // Convert each string to upper case and add it to the local array
